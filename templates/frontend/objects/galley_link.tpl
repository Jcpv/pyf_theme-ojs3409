...
{*** Jc *** AJUSTANDO TEXTO del BTN de GALERADAS ***}

{* Don't be frightened. This is just a link *}
<a class="galley-link px-4 py-2 btn-galerada-texto btn {if $isSupplementary}btn-default{else}btn-primary{/if} {$type}" role="button" href="{url page=$page op="view" path=$path}">
